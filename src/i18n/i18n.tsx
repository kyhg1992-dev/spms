...
const DICT: Record<string, { ar: string; en: string }> = {
  ...
  "nav.meter": { ar: "تحديث العدّاد", en: "Meter Update" },
  "meter.title": { ar: "تحديث قراءة العدّاد", en: "Update meter reading" },
  "meter.subtitle": { ar: "ابحث عن المركبة برقم الأصل أو اللوحة وحدّث القراءة.", en: "Find the vehicle by asset/plate number and update its reading." },
  "meter.search": { ar: "بحث برقم الأصل أو اللوحة", en: "Search by asset or plate number" },
  "meter.noResults": { ar: "لا نتائج — اكتب رقم الأصل أو اللوحة.", en: "No results — type an asset or plate number." },
  "meter.current": { ar: "القراءة الحالية", en: "Current reading" },
  "meter.newReading": { ar: "القراءة الجديدة", en: "New reading" },
  "meter.hours": { ar: "ساعات", en: "Hours" },
  "meter.km": { ar: "كيلومتر", en: "Km" },
  "meter.save": { ar: "حفظ القراءة", en: "Save reading" },
  "meter.saved": { ar: "تم تحديث القراءة", en: "Reading updated" },
  "meter.invalid": { ar: "أدخل قيمة صحيحة", en: "Enter a valid value" },
  "meter.modeSingle": { ar: "فردي", en: "Single" },
  "meter.modeBulk": { ar: "جماعي", en: "Bulk" },
  "meter.branch": { ar: "الفرع", en: "Branch" },
  "meter.allBranches": { ar: "كل الفروع", en: "All branches" },
  ...
  "scan.loginToAct": { ar: "سجّل الدخول لتسجيل قراءة أو طلب صيانة.", en: "Sign in to record a reading or request maintenance." },
  "scan.login": { ar: "تسجيل الدخول", en: "Sign in" },
  "scan.publicView": { ar: "عرض عام — معلومات الصيانة", en: "Public view — maintenance info" },
  // Login
  ...
  "wod.execDuration": { ar: "مدة التنفيذ", en: "Execution duration" },
  "dur.d": { ar: "ي", en: "d" },
  "dur.h": { ar: "س", en: "h" },
  "dur.m": { ar: "د", en: "m" },
  ...
  "reqp.duplicate": { ar: "رقم الطلب مستخدم بالفعل في أمر عمل آخر", en: "This request number is already used by another work order" },
  "reqp.bypassHint": { ar: "أدخل رقم الطلب، أو شفرة التجاوز لإدخاله لاحقاً.", en: "Enter the request number, or the bypass code to enter it later." },
  "reqp.bypassed": { ar: "تم تجاوز رقم الطلب — يجب إدخاله لاحقاً", en: "Request number bypassed — must be entered later" },
  "reqp.plan": { ar: "خطة الصيانة", en: "Maintenance plan" },
  "wo.requestPending": { ar: "رقم الطلب مؤجَّل", en: "Request no. pending" },
  "set.bypassCode": { ar: "شفرة تجاوز رقم الطلب", en: "Request-number bypass code" },
  "set.bypassCodeHint": { ar: "تُدخل بدل رقم الطلب لتأجيله مع توثيق التجاوز. اتركها فارغة لاستخدام الافتراضية.", en: "Entered instead of the request number to defer it, with the bypass recorded. Leave blank for the default." },
